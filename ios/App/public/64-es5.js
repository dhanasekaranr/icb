        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Spinner = /** @class */ (function () {
                ...
                class_1.prototype.getName = function () {
                    var spinnerName = this.name || _config_bb99b659_js__WEBPACK_IMPORTED_MODULE_1__["b"].get('spinner');
                ...
                class_1.prototype.render = function () {
                    var _a;
                    var self = this;
                    var mode = Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_0__["d"])(self);
                    ...
                    return (Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_0__["H"], { class: Object.assign({}, Object(_theme_353a032e_js__WEBPACK_IMPORTED_MODULE_2__["c"])(self.color), (_a = {}, _a[mode] = true, _a["spinner-" + spinnerName] = true, _a['spinner-paused'] = !!self.paused || _config_bb99b659_js__WEBPACK_IMPORTED_MODULE_1__["b"].getBoolean('_testing'), _a)), role: "progressbar", style: spinner.elmDuration ? { animationDuration: duration + 'ms' } : {} }, svgs));
                };
            ...
            var buildCircle = function (spinner, duration, index, total) {
                ...
                return (Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("svg", { viewBox: data.viewBox || '0 0 64 64', style: data.style }, Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("circle", { transform: data.transform || 'translate(32,32)', cx: data.cx, cy: data.cy, r: data.r, style: spinner.elmDuration ? { animationDuration: duration + 'ms' } : {} })));
            };
            var buildLine = function (spinner, duration, index, total) {
                var data = spinner.fn(duration, index, total);
                data.style['animation-duration'] = duration + 'ms';
                return (Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("svg", { viewBox: data.viewBox || '0 0 64 64', style: data.style }, Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("line", { transform: "translate(32,32)", y1: data.y1, y2: data.y2 })));
            };
            /***/ 
        })
    }]);
