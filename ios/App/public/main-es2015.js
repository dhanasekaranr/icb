...
let NotificationPopoverPage = class NotificationPopoverPage {
    ...
    close() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const topLoader = yield this.viewCtrl.getTop();
            if (topLoader) {
                yield topLoader.dismiss(this.notifications.length);
            }
        });
    }
};
NotificationPopoverPage.ctorParameters = () => [
...
let PopoverPage = class PopoverPage {
    constructor(viewCtrl, service, toastCtrl, navParams) {
        this.viewCtrl = viewCtrl;
    ...
    deleteFromWishList(ISBN, i) {
        this.service.AddToWishList(ISBN).then((data) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
...
let HeaderPage = class HeaderPage {
    constructor(navCtrl, authentication, location) {
...
let Authentication = class Authentication {
    constructor(http, credentialsAuthentication, storage, globalSettings) {
        this.http = http;
    ...
    credentialsLogin(credentials) {
        ...
        return this.credentialsAuthentication.login(credentials)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])((body) => {
...
let CredentialsAuthentication = class CredentialsAuthentication {
    // private accessTokenSubject:ReplaySubject<any> = new ReplaySubject(1);
    constructor(http, globalSettings) {
        this.http = http;
        this.globalSettings = globalSettings;
        // Set the baseUrl variable to the Api Url from the GlobalSettings
        this.baseUrl = this.globalSettings.getSettings().apiUrl;
...
CredentialsAuthentication.ctorParameters = () => [
...
let GlobalFunctions = class GlobalFunctions {
    // private apiUrl = 'http://api.icarebooks.com';
    constructor(navCtrl, authentication, http, storage) {
        this.navCtrl = navCtrl;
        this.authentication = authentication;
        this.http = http;
        this.storage = storage;
...
GlobalFunctions.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"] },
...
let ICBService = class ICBService {
    constructor(http, storage, globalSettings, func) {
        this.http = http;
        this.storage = storage;
        this.globalSettings = globalSettings;
        this.func = func;
