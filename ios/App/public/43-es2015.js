...
const mdEnterAnimation = (baseEl, ev) => {
    ...
    const viewportAnimation = Object(_animation_22971d74_js__WEBPACK_IMPORTED_MODULE_2__["c"])();
    backdropAnimation
        .addElement(baseEl.querySelector('ion-backdrop'))
...
const Popover = class {
    constructor(hostRef) {
        ...
        this.onBackdropTap = () => {
            this.dismiss(undefined, _overlays_45908d8d_js__WEBPACK_IMPORTED_MODULE_4__["B"]);
        };
    ...
    async present() {
        ...
        await Object(_index_63698b4d_js__WEBPACK_IMPORTED_MODULE_7__["d"])(this.usersElement);
        return Object(_overlays_45908d8d_js__WEBPACK_IMPORTED_MODULE_4__["d"])(this, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, this.event);
    }
    /**
    ...
    async dismiss(data, role) {
        const shouldDismiss = await Object(_overlays_45908d8d_js__WEBPACK_IMPORTED_MODULE_4__["e"])(this, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, this.event);
        if (shouldDismiss) {
