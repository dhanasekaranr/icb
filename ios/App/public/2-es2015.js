...
const ActionSheet = class {
    ...
    async callButtonHandler(button) {
        if (button) {
            ...
            const rtn = await Object(_overlays_45908d8d_js__WEBPACK_IMPORTED_MODULE_3__["s"])(button.handler);
            if (rtn === false) {
...
const buttonClass = (button) => {
    return Object.assign({ 'action-sheet-button': true, 'ion-activatable': true, [`action-sheet-${button.role}`]: button.role !== undefined }, Object(_theme_353a032e_js__WEBPACK_IMPORTED_MODULE_4__["g"])(button.cssClass));
};
