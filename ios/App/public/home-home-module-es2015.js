...
let HomePage = class HomePage {
    constructor(navCtrl, authentication, service, popoverCtrl, ms, loading) {
    ...
    ionViewWillEnter() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.authentication.getAccessToken() != null) {
                this.RentedOut = 0;
                this.loader = yield this.loading.create({ message: 'loading dashboard...' });
    ...
    notificationPopover(myEvent) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const popover = yield this.popoverCtrl.create({ component: _notificationPopover__WEBPACK_IMPORTED_MODULE_8__["NotificationPopoverPage"], componentProps: { data: this.notification } });
            popover.present();
            popover.onDidDismiss();
        });
    }
    ...
    getNotificationList() {
        this.service.getNotificationList().then(data => {
            this.notification = data;
            this.NotificationCount = this.notification.length;
        });
    }
    getRentalTransactions() {
        this.service.getRentalTransactions().then(data => {
    ...
    getActiveWishList() {
        this.service.getActiveWishList().then(data => {
            this.wishes = data;
            this.WishesCount = this.wishes.length;
        });
    }
    getBookCounts() {
        this.service.searchTrans('book', '').then(data => {
            this.books = data;
    ...
    getRentalStatus() {
        this.service.getRentalStatus('monthly', '0').then(data => {
            this.booksStat = data;
